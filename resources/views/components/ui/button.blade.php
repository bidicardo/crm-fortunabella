...
@php
    ...
    $base = 'inline-flex min-h-11 items-center justify-center gap-2 rounded-md py-2 text-body font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent disabled:cursor-not-allowed disabled:opacity-50';
    $variants = [
        'primary' => 'px-4 bg-accent-fill text-white hover:bg-accent-hover active:bg-accent-active',
        'secondary' => 'px-4 border border-line text-ink hover:bg-surface',
